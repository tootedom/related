 ...
 */
public class RelatedProductAdditionalPropertiesTest {
    ...
    public void testPropertyMerging() {
        RelatedProductAdditionalProperties properties1 = new RelatedProductAdditionalProperties(config,2);
        RelatedProductAdditionalProperties properties2 = new RelatedProductAdditionalProperties(config,2);
        ...
        RelatedProductAdditionalProperties combined = new RelatedProductAdditionalProperties(properties1,properties2);
    ...
    public void testPropertyStringLength() {
        RelatedProductAdditionalProperties properties1 = new RelatedProductAdditionalProperties(config,3);
    ...
    public void testPropertiesToString() {
        ...
        properties1 = new RelatedProductAdditionalProperties(config,3);
