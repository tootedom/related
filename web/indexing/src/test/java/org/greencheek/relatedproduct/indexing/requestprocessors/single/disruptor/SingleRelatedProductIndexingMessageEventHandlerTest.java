...
public class SingleRelatedProductIndexingMessageEventHandlerTest {
    ...
    public void setUp() {
        ...
        handler = new SingleRelatedProductIndexingMessageEventHandler(configuration.getIndexBatchSize(),new BasicRelatedProductIndexingMessageConverter(configuration),
