 ...
 */
@Named
public class JodaUTCCurrentDateAndHourAndMinuteFormatter implements UTCCurrentDateAndHourAndMinuteFormatter {
    ...
    private final DateTimeFormatter formatter = DateTimeFormat.forPattern("yyyy-MM-dd'_'HH':'mm");
    ...
    @Override
    public String parseToDateAndHourAndMinute(String dateAndOrTime) {
