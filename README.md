...
- [Relateit]
	...
	- [More Indexing](#more-indexing)
		...
		- [Default Searching and Indexing](#default-searching-and-indexing)
		    - [Installing the Plugin](#installing-the-plugin)
		    - [Returning Related Documents](#returning-related-documents)
		    - [Updating Related Documents](#updating-related-documents)
...
* 1.1.0 : https://oss.sonatype.org/content/repositories/releases/org/greencheek/related/related-web-searching/1.1.0/related-web-searching-1.1.0.war (es v1.0.1)
* 1.0.6 : https://oss.sonatype.org/content/repositories/releases/org/greencheek/related/related-web-searching/1.0.5/related-web-searching-1.0.6.war (es v1.0.1)
...
* 1.1.0 : https://oss.sonatype.org/content/repositories/releases/org/greencheek/related/related-web-indexing/1.1.0/related-web-indexing-1.1.0.war (es v1.0.1)
* 1.0.6 : https://oss.sonatype.org/content/repositories/releases/org/greencheek/related/related-web-indexing/1.0.6/related-web-indexing-1.0.6.war (es v1.0.1)
