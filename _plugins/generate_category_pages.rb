...
module Jekyll
  ...
  class CategoryPages < Generator
    ...
    def paginate(site, page)
      ...
      category_posts = site.categories[page.data['category']]
      category_posts = category_posts.sort_by { |p| p.data['indexing_no'] }
      ...
      (0..pages).each do |num_page|
        ...
        if num_page > 0 
          ...
          newpage.pager = pager
          newpage.dir = File.join(page.dir, "/#{page.dir}#{num_page}")
          site.pages << newpage
        else
          page.pager = CategoryPager.new(site, 1, category_posts, page.data['category'], pages)
        end
